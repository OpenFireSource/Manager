...
export class AuthService {
  ...
  constructor(
    ...
    // this.isAuthenticated$.pipe(distinctUntilChanged()).subscribe(x => this.isAuthenticated.set(x));
  ...
  public get userRoles(): string[] {
    ...
    const decoded = jwtDecode<AccessTokenDto>(accessToken);

    return decoded.resource_access?.["manager-backend"]?.roles ?? [];
  }
}
