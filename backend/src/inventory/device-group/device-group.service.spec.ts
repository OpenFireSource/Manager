...
describe('DeviceGroupService', () => {
  ...
  let dbService: DeviceGroupDbService;

  beforeEach(async () => {
    dbService = {} as DeviceGroupDbService;
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        DeviceGroupService,
        {
          provide: DeviceGroupDbService,
          useValue: dbService,
        },
      ],
    }).compile();
  ...
  describe('findOne', () => {
    it('should call findOne with correct parameters', async () => {
      const id = 1;
      const entity = new DeviceGroupEntity();
  ...
  describe('create', () => {
    it('should call create with correct parameters', async () => {
      const body = new DeviceGroupCreateDto();
  ...
  describe('update', () => {
    it('should call update with correct parameters', async () => {
      const id = 1;
      const body = new DeviceGroupUpdateDto();
